import { View, SafeAreaView, Text, Image, Modal, ScrollView } from 'react-native';
						...
						{movie ? (
							<View style={{ width: '100%' }}>
								<View style={styles.topInfo}>
									<Image style={styles.moviePoster} source={{ uri: base_path + movie.poster_path }} />
									<View
										style={{
									...
									>
										...
										<View style={{ flexDirection: 'row', paddingTop: 5, alignItems: 'center' }}>
											...
											<Text style={styles.infoText}>{movie.vote_average.toFixed(2)}</Text>
								...
								{movie.services && movie.services.length > 0 ? (
									<View style={styles.servicesContainer}>
										...
										<View style={{ paddingTop: 15, flexDirection: 'row', flexWrap: 'wrap' }}>
											{movie.services.map((service) => {
												const path = 'https://image.tmdb.org/t/p/original/' + service.logo_path;
												return (
													<Image
