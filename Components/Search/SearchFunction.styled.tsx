import { StyleSheet, View, TouchableOpacity, Image, TextInput, Text, ImageSourcePropType } from 'react-native';
...
export const ImageButton: React.FC<{ movie: Movie; onPress: (movie: Movie) => void; isSelected: boolean }> = ({
	movie,
	onPress,
	isSelected
}) => {
	...
	return (
		...
		>
			...
			<Text numberOfLines={2} style={{ paddingTop: 5, color: 'white', textAlign: 'center' }}>
				{movie.title}
			</Text>
		</View>
	);
...
export const LogoLarge = () => {
	...
	return (
		<View>
			<View style={{ flexDirection: 'row', alignItems: 'center', gap: 5 }}>
				<Ionicons name="film-outline" color="white" size={50} />
				<Text style={{ color: 'white', fontSize: 45, fontWeight: 'bold' }}>ReelRecs</Text>
			</View>
			<View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5 }}>
				<Text style={{ color: 'white', fontWeight: '300', fontSize: 18 }}>Powered by</Text>
				<Image
					source={imagePath as ImageSourcePropType}
					resizeMode="contain"
